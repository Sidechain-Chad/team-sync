class Card < ApplicationRecord
  ...
  # :cover is preprocessed (generated by a background job at upload time)
  # so rendering the board never blocks on synchronous variant processing.
  has_many_attached :attachments do |attachable|
    attachable.variant :cover, resize_to_fill: [560, 200], preprocessed: true
  end
